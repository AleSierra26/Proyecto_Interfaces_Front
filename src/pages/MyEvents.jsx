    ...
    return (
        <div className="min-h-screen bg-background max-w-md mx-auto relative pb-20">
            ...
            <section className="flex flex-col items-center px-4 py-5 border-b border-border">
                ...
                <div className="flex flex-row gap-3 my-3 w-[80%]">
                    ...
                    <button className='w-[100%] py-3 border border-border text-muted-foreground font-sans-serif font-medium text-xs uppercase tracking-widest rounded-[10px] hover:bg-primary-foreground hover:text-primary hover:border-primary transition-colors'>
                        Editar evento
                    </button>
                </div>
            </section>
